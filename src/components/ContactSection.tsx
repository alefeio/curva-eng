            ...
            <div className="max-w-7xl mx-auto text-center">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                    ...
                    <div className="flex flex-col items-center p-6 bg-gray-800 rounded-lg shadow-md">
                        <h4 className="font-bold text-gray-800 text-xl mb-4 text-white">Contatos</h4>
                    ...
                    {/* Mídias Sociais */}
                    <div className="flex flex-col items-center p-6 bg-gray-800 rounded-lg shadow-md">
                        <h4 className="font-bold text-gray-800 text-xl mb-4 text-white">Siga-nos</h4>
                    ...
                    <div className="flex flex-col items-center p-6 bg-gray-800 rounded-lg shadow-md lg:col-span-1 md:col-span-2">
                        <h4 className="font-bold text-gray-800 text-xl mb-4 text-white">Nossa Localização</h4>
                        <address className="text-orange-500 font-semibold not-italic text-center text-gray-600 mb-4">
